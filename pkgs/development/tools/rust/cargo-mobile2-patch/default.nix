{
  ...
  pname = "cargo-mobile2";
  version = "9e4347ef7e1fd19ce18e3d92b1488468a7660f45";
in
  rustPlatform.buildRustPackage {
    ...
    src = fetchFromGitHub {
      ...
      repo = pname;
      rev = "${version}";
      hash = "sha256-BQIxsydyOBJYBDHC60iD0nW3VryHB7egP2KJbHL7NK8=";
    };
    ...
    cargoHash = "sha256-iH2kx0rOuaeUiiIFeMj7Lu9wRe3n4yJp4n2Pt6GR2KI=";
